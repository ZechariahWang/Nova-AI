    ...
    <div className="h-screen p-3 overflow-hidden">
      ...
      <div className="h-full grid grid-cols-6 grid-rows-6 gap-3">
        ...
        <section className='col-span-6 md:col-span-4 row-span-2 relative overflow-hidden bg-gradient-to-br from-[rgb(22,22,22)] to-[rgb(18,18,18)] rounded-3xl p-4 sm:p-6 shadow-[0_8px_16px_0_rgba(0,255,195,0.08)] border border-white/8'>
          ...
          <div className="relative z-10 flex flex-col justify-between h-full gap-4 sm:gap-0">
        ...
        <div className="col-span-3 md:col-span-2 row-span-1 bg-[rgb(22,22,22)] rounded-2xl p-3 sm:p-4 shadow-[0_6px_12px_0_#00ffc3] border border-white/5 flex flex-col justify-center">
        ...
        <div className="col-span-3 md:col-span-2 row-span-1 bg-[rgb(22,22,22)] rounded-2xl p-3 sm:p-4 shadow-[0_6px_12px_0_#ff34a1] border border-white/5 flex flex-col justify-center">
          <div className="flex items-center justify-between mb-2">
